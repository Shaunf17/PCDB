namespace PCDB.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.Storage", "Id", "dbo.Component");
            DropForeignKey("dbo.Memory", "Id", "dbo.Component");
            DropForeignKey("dbo.CPUCooler", "Id", "dbo.Component");
            DropForeignKey("dbo.CPU", "Id", "dbo.Component");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.Component", "Manufacturer_Id", "dbo.Manufacturer");
            DropIndex("dbo.Storage", new[] { "Id" });
            DropIndex("dbo.Memory", new[] { "Id" });
            DropIndex("dbo.CPUCooler", new[] { "Id" });
            DropIndex("dbo.CPU", new[] { "Id" });
            ...
            DropIndex("dbo.Component", new[] { "Manufacturer_Id" });
